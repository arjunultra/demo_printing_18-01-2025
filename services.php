                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="img-carousel" data-carousel="business-card">
                                <div>
                                    <img id="largeImage" class="large-image" src="./images/bcard-1.webp"
                                        alt="Large Image">
                                </div>
                                <div class="row small-images-container mt-3">
                                    <div class="col-3">
                                        <img class="small-image" src="./images/b-card-4.webp" alt="Small Image 1">
                                    </div>
                                    <div class="col-3">
                                        <img class="small-image" src="./images/bcard-3.webp" alt="Small Image 2">
                                    </div>
                                    <div class="col-3">
                                        <img class="small-image" src="./images/bcard-5.webp" alt="Small Image 3">
                                    </div>
                                    <div class="col-3">
                                        <img class="small-image" src="./images/bcard-2.webp" alt="Small Image 4">
                                    </div>
                                </div>
                            </div>
                        </div>
